namespace Envelope
{
    static public class TextMessages
    {
        public const string INPUT_PARAMETERS_FOR_FIRST_ENVELOPE = "Please, input height and width for first envelope by ' ' separator";
        public const string INPUT_PARAMETERS_FOR_SECOND_ENVELOPE = "Please, input height and width for second envelope by ' ' separator";
